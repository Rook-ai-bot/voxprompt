...
- **BYOK via OpenRouter** — bring your own API key, use any model on OpenRouter (Claude, GPT, Llama, Mistral, etc.)

## Features (planned)

- [ ] Global hotkey recording on macOS
- [ ] Whisper-based transcription (local or cloud)
- [ ] OpenRouter integration (BYOK — user provides their key)
...
- **OpenRouter API** for prompt refactor + translation
